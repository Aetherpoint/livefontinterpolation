...
var jDataView = function (buffer, byteOffset, byteLength, littleEndian) {
	...
	if (!this._isDataView) {
		...
		if (typeof byteOffset < 0) {
			throw new Error("INDEX_SIZE_ERR: DOM Exception 1 - byteOffset");
		}
		if (typeof byteLength < 0) {
			throw new Error("INDEX_SIZE_ERR: DOM Exception 1 – byteLength");
		}
	}
	...
	if (this._end >= bufferLength) {
		throw new Error("INDEX_SIZE_ERR: DOM Exception 1 - byteOffset Start");
	}
		...
		jDataView.prototype['get' + type] = 
			function (byteOffset, littleEndian) {
				...
				// ArrayBuffer does not support endianess flag (for size > 1)
					...
					// This is what's dropping out out alternate fonts that aren't provided by default?
